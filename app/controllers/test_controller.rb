class TestController < ApplicationController
  def test
  	...
  	p "ok 2"
  	var2 = system 'heroku ps:scale web=1:standard-1x --app cli-test-1'
  	var2 = system 'heroku ps:scale web1=1:standard-1x --app cli-test-1'
  	var3 = system 'heroku ps:scale web2=1:standard-1x --app cli-test-1'
  	# var3 = system 'ps'
  ...
  def off
  	...
  	var5 = system 'heroku ps:resize web=hobby'
  	p var1
  	p var2
  	p var3
  	p var4
